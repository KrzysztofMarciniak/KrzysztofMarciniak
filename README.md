...
### About me
* pc: [artix](https://artixlinux.org/), [OpenRC](https://wiki.artixlinux.org/Main/OpenRC), [btrfs](https://btrfs.readthedocs.io/en/latest/), [libvibrant (monochrome)](https://github.com/libvibrant/libvibrant), [lighttpd](https://www.lighttpd.net/){[cgit](https://git.zx2c4.com/cgit/), [kiwix serve](https://github.com/kiwix/kiwix-tools)}, [dnsmasq](https://wiki.archlinux.org/title/Dnsmasq), [st](https://st.suckless.org/), [mwm](https://github.com/KrzysztofMarciniak/minimal-window-manager), [dmenu](https://tools.suckless.org/dmenu/), [xlibre](https://github.com/x11libre), [gimp](https://www.gimp.org/downloads/), [apparmor](https://packages.artixlinux.org/packages/world/x86_64/apparmor/), [firejail](https://packages.artixlinux.org/packages/world/x86_64/firejail/), [organic maps](https://organicmaps.app/), [qemu](https://wiki.archlinux.org/title/QEMU), [yay](https://github.com/Jguer/yay), [pass](https://www.passwordstore.org/) + [gocryptfs](https://wiki.archlinux.org/title/Gocryptfs), [librewolf](https://librewolf.net/){[ublock origin](https://ublockorigin.com/), [dark reader](https://darkreader.org/), [decentraleyes](https://addons.mozilla.org/en-US/firefox/addon/decentraleyes/), [vimium c](https://addons.mozilla.org/pl/firefox/addon/vimium-c/)}, [sdr++](https://www.sdrpp.org/), [docker](https://wiki.archlinux.org/title/Docker), [doom emacs](https://github.com/doomemacs/doomemacs) with (i.a.) [org-modern](https://github.com/minad/org-modern), [commit mono](https://github.com/eigilnikolajsen/commit-mono), [mono theme](https://github.com/KrzysztofMarciniak/doom-mono-dark-theme)
