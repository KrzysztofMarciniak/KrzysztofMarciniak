...
### About me
* pc: [st](https://st.suckless.org/), [mwm](https://github.com/KrzysztofMarciniak/minimal-window-manager), [xlibre](https://github.com/x11libre), [dmenu](https://tools.suckless.org/dmenu/), [artix](https://artixlinux.org/), [btrfs](https://btrfs.readthedocs.io/en/latest/), [s6](https://skarnet.org/software/s6-linux-init/), [doom emacs](https://github.com/doomemacs/doomemacs) with [mono theme](https://github.com/KrzysztofMarciniak/doom-mono-dark-theme)
