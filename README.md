...
### About me
* pc: [st](https://st.suckless.org/), [cgit](https://git.zx2c4.com/cgit/), [dnsmasq](https://wiki.archlinux.org/title/Dnsmasq), [mwm](https://github.com/KrzysztofMarciniak/minimal-window-manager), [xlibre](https://github.com/x11libre), [apparmor](https://packages.artixlinux.org/packages/world/x86_64/apparmor/), [firejail](https://packages.artixlinux.org/packages/world/x86_64/firejail/), [dmenu](https://tools.suckless.org/dmenu/), [artix](https://artixlinux.org/), [btrfs](https://btrfs.readthedocs.io/en/latest/), [librewolf](https://librewolf.net/){[kiwix js](https://github.com/kiwix/kiwix-js), [ublock origin](https://ublockorigin.com/), [decentraleyes](https://addons.mozilla.org/en-US/firefox/addon/decentraleyes/), [vimium c](https://addons.mozilla.org/pl/firefox/addon/vimium-c/)}, [sdr++](https://www.sdrpp.org/), [OpenRC](https://wiki.artixlinux.org/Main/OpenRC), [doom emacs](https://github.com/doomemacs/doomemacs) with [mono theme](https://github.com/KrzysztofMarciniak/doom-mono-dark-theme)
