...
| [**cpass**](https://github.com/KrzysztofMarciniak/cpass) | Extremely simple pass alternative written in C with openssl. | ![C](https://img.shields.io/badge/C-blue?logo=c) ![OpenSSL](https://img.shields.io/badge/OpenSSL-lightgrey) |
| [**screenc**](https://github.com/KrzysztofMarciniak/screenc) | Screenshot tool written in C using only PNG and X11. | ![C](https://img.shields.io/badge/C-blue?logo=c) ![PNG](https://img.shields.io/badge/PNG-lightgrey) ![X11](https://img.shields.io/badge/X11-lightgrey) |
