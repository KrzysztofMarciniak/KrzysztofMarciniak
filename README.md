...
### About me
* pc: [st](https://st.suckless.org/), [lighttpd](https://www.lighttpd.net/){[cgit](https://git.zx2c4.com/cgit/), [kiwix serve](https://github.com/kiwix/kiwix-tools)}, [dnsmasq](https://wiki.archlinux.org/title/Dnsmasq), [mwm](https://github.com/KrzysztofMarciniak/minimal-window-manager), [xlibre](https://github.com/x11libre), [gimp](https://www.gimp.org/downloads/), [apparmor](https://packages.artixlinux.org/packages/world/x86_64/apparmor/), [firejail](https://packages.artixlinux.org/packages/world/x86_64/firejail/), [yay](https://github.com/Jguer/yay), [dmenu](https://tools.suckless.org/dmenu/), [artix](https://artixlinux.org/), [pass](https://www.passwordstore.org/), [btrfs](https://btrfs.readthedocs.io/en/latest/), [librewolf](https://librewolf.net/){[ublock origin](https://ublockorigin.com/), [dark reader](https://darkreader.org/), [decentraleyes](https://addons.mozilla.org/en-US/firefox/addon/decentraleyes/), [vimium c](https://addons.mozilla.org/pl/firefox/addon/vimium-c/)}, [sdr++](https://www.sdrpp.org/), [docker](https://wiki.archlinux.org/title/Docker), [OpenRC](https://wiki.artixlinux.org/Main/OpenRC), [doom emacs](https://github.com/doomemacs/doomemacs) with [org-modern](https://github.com/minad/org-modern) [emms](https://www.gnu.org/software/emms/), [mono theme](https://github.com/KrzysztofMarciniak/doom-mono-dark-theme)
